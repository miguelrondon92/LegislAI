...
### `production_email_config.env.example`
Email service configuration template for different providers. Copy to `production_email_config.env` (gitignored) and fill in real values.
