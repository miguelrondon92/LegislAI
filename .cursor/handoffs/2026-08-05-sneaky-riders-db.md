...
- **Change:** Sneaky riders (= hidden provisions) now persist to `HiddenProvision` on the live complete-analysis path; bill detail heals empty tables from analysis JSON. Profile shows collapsible **“N sneaky riders detected”** reading only the DB.
