...
def setup_gmail_smtp():
    ...
    try:
        ...
        logger.info("      export GMAIL_USERNAME=miguelrondon92@gmail.com")
...
MAIL_USE_TLS=True
MAIL_USE_SSL=False
MAIL_USERNAME=miguelrondon92@gmail.com
MAIL_PASSWORD=your-gmail-app-password-here
MAIL_DEFAULT_SENDER=miguelrondon92@gmail.com
...
"""
        ...
        with open('/Users/miguelrondon/Desktop/code/legislai/production_email_config.env', 'w') as f:
...
def main():
    ...
    if not gmail_user:
        ...
        logger.info("   - Run: export GMAIL_USERNAME=miguelrondon92@gmail.com")
        ...
        logger.info("📧 Check miguelrondon92@gmail.com inbox")
